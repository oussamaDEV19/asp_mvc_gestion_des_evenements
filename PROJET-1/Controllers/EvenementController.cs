...
namespace PROJET_1.Controllers
{
    public class EvenementController : Controller
    {
        ...
        public ActionResult events_img()
        {
            ...
            return View(db.activites.Where(u=> u.state.Equals("enable")).ToList());
        }
        ...
        {
            Model1 db = new Model1();
            int last_id = db.activites.Where(e => e.state.Equals("enable")).OrderByDescending(u => u.id).FirstOrDefault().id;
            Activite act = db.activites.Find(last_id);
